...
```mermaid
flowchart LR
    P["Product: plain white T-shirt"] --> M["Meaning: freedom to explore"]
    M --> I["Identity: I choose my own path"]
    I --> A["Audience: people seeking everyday discovery"]
    A -->|Feedback tests the interpretation| M
```
